...
const lexer = require('./parse/lex.ts').lexer;
...
var grammar = {
    ...
    {"name": "Top$ebnf$1", "symbols": ["Top$ebnf$1", "Top$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "Top$ebnf$2", "symbols": ["Top$ebnf$2", "Top$ebnf$2$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "BlockStatement$ebnf$1", "symbols": ["BlockStatement$ebnf$1", "BlockStatement$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "AnnoSet$ebnf$1", "symbols": ["AnnoSet$ebnf$1", "Anno_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "AnnoSet$ebnf$2", "symbols": ["AnnoSet$ebnf$2", "Anno_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "AnnoSet$ebnf$3", "symbols": ["AnnoSet$ebnf$3", "Anno_"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "AnnoSet$ebnf$4", "symbols": []},
    {"name": "AnnoSet$ebnf$4", "symbols": ["AnnoSet$ebnf$4", (lexer.has("comment") ? {type: "comment"} : comment)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "StatementNoDangle$ebnf$1", "symbols": ["StatementNoDangle$ebnf$1", "StatementNoDangle$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "StatementPrefix$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "StatementPrefix$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    ...
    {"name": "StatementEnd$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
